package com.chipswu.aiapplicationgenerator.core.handler;
 ...
 * 根据代码生成类型创建合适地流处理器：
 * <ul>
 *      <li>1. 传统的 Flux<String> 流（HTML、MULTI_FILE） -> SimpleTextStreamHandler</li>
 *      <li>2. TokenStream 格式的复杂流（VUE_PROJECT） -> JsonMessageStreamHandler</li>
 * </ul>
 *
 * @author WuJiaJun
 */
