<template>
  <div id="homePage">
    <div class="container">
      ...
      <!-- 我的作品 -->
      <div class="section" v-if="loginUserStore.loginUser">
...
const loadMyApps = async () => {
  ...
  try {
    ...
    if (response.code === 0 && response.data) {
      ...
      myAppsPage.total = Number.parseInt(response.data.totalRow) || 0
    }
  } catch (error) {
...
const loadFeaturedApps = async () => {
  try {
    ...
    if (response.code === 0 && response.data) {
      ...
      featuredAppsPage.total = Number.parseInt(response.data.totalRow) || 0
    }
  } catch (error) {
